  ...
  namespace MeshRefinement
  {
      ...
      public SimulatorAccess<dim>
    {
      ...
      private:
         ...
         * for the crust of the slab lithosphere, 
         * mantle part of the slab lithosphere, 
         * the overriding plate,
         * the adjacent plate,
         * the transform zone and the
         * mantle.
         */
        ...
        std::vector<unsigned int> adjacent_refinement;
        std::vector<unsigned int> weakzone_refinement;
